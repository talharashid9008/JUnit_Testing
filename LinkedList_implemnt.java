...
public class LinkedList_implemnt{
	public int data;    
	LinkedList_implemnt nextPointer;
	
	static int numofElements;
	static LinkedList_implemnt headPointer;
	static LinkedList_implemnt tailPointer;

	public LinkedList_implemnt(){
		nextPointer=null;
	}
	...
	public void add(int number){
		...
		LinkedList_implemnt node = new LinkedList_implemnt();
		node.data=number;
	...
	public void display(){
		...
		System.out.print("[ ");
		LinkedList_implemnt temp = headPointer;
		while(temp!=null){
